...
public class OkHttpClientManager
{
    ...
    private Gson mGson;
   // public static String BASE_URL="http://121.42.199.210:8067/dmsock";
   // public static String BASE_URL="https://121.42.199.210:8018/dmsock/";
    public static String BASE_URL="http://dingmou.net:8019/dmsock/";
    public static String Fcust_Name="";//
     ...
     * 异步基于post的文件上传:主方法
     */
    public void postAsyn(String url, String[] fileKeys, File[] files, Param[] params,Object tag,
     ...
     * 异步基于post的文件上传:主方法
     */
    public static void postAsyn1(String url, String[] fileKeys, File[] files, Param[] params,Object
        tag,ResultCallback callback)
    {
