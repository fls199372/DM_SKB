...
public  class IntegralCostBreakdownActivity extends BaseActivity implements ResponseT<ResponseList<IntegralList>> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.integral_cost_breakdown_main);
     ...
     //   listView.setOnItemClickListener(this);
        ...
        listView.setOnRefreshListener(new OnRefreshListener2<ListView>(){
            public void onPullDownToRefresh(
                ...
                PageIndex=1;
                resultList.clear();
                integralDao.getIntegralList(Common.fuser_id+"/2000/"+PageIndex,
                        IntegralCostBreakdownActivity.this);
        ...
        dialog= CustomProgress.show(IntegralCostBreakdownActivity.this, "正在查询积分消耗明细", false, null);
        integralDao.getIntegralList(Common.fuser_id+"/2000/"+PageIndex,this);
    }
    private void init()
    {
...
//        	adapter.notifyDataSetChanged();
    ...
    public void getT(ResponseList<IntegralList> t) {
        for(int i=0;i<t.getData().size();i++){
            ...
            arg.put("period",t.getData().get(i).getCompanyName());
