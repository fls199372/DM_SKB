...
public class IntegralDetailActivity extends BaseActivity implements ResponseT<ResponseList<RechargeQusery>> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.integraldetail_main);
        ...
        listView.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ListView>(){
            public void onPullDownToRefresh(
                ...
                PageIndex=1;
                resultList.clear();
                integralDao.getRechargeQusery(Common.fuser_id+"/2002/"+PageIndex,
        ...
        dialog= CustomProgress.show(IntegralDetailActivity.this, "正在查询积分明细", false, null);
        integralDao.getRechargeQusery(Common.fuser_id+"/2002/"+PageIndex,this);
