...
public  class RechargeQueryActivity extends BaseActivity implements ResponseT<ResponseList<RechargeQusery>> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.recharge_query_main);
     ...
     //   listView.setOnItemClickListener(this);
        ...
        listView.setOnRefreshListener(new OnRefreshListener2<ListView>(){
            public void onPullDownToRefresh(
                ...
                PageIndex=1;
                resultList.clear();
                integralDao.getRechargeQusery(Common.fuser_id+"/2001/"+PageIndex,
                        RechargeQueryActivity.this);
        ...
        dialog= CustomProgress.show(RechargeQueryActivity.this, "正在查询充值历史", false, null);
        integralDao.getRechargeQusery(Common.fuser_id+"/2001/"+PageIndex,this);
    }
...
//        	adapter.notifyDataSetChanged();
    ...
    public void getT(ResponseList<RechargeQusery> t) {
        for(int i=0;i<t.getData().size();i++){
            ...
            arg.put("period",t.getData().get(i).getFeeMoney());
